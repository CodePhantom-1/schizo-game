...
Usage: python3 tools/plot_city.py [out.png]
"""
import csv
import math
import pathlib
...
def main(out):
    types = {t["id"]: t for t in csv.DictReader(open(ROOT / "db/canon/building_types.csv"))}
    places = list(csv.DictReader(open(ROOT / "db/canon/places.csv")))
...
if __name__ == "__main__":
    main(sys.argv[1] if len(sys.argv) > 1 else ROOT / "art/review/city_plan.png")
