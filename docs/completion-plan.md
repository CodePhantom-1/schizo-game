...
**Progress:** batch 1 (2026-09-26) — the asset pipeline (licence gate, fetchers, palette, trim atlas with wear) and V1–V3 for the crescent: every building generated from its data row, one mesh each, trade markers, wear by wealth (HANDOFF "Stage V batch 1"). Batch 2 (2026-09-26) — flora and street life: `flora.csv`, 36 palette-locked scatter meshes (packs + code-built marsh and desert plants), 1,053 instances placed from data around the crescent, withering with the drought and flowering in season (HANDOFF "Stage V batch 2"). Batch 3 (2026-09-26) — the terrain: a ground detail per kind under Tommy's colours (cracking and salting with the drought), levees, tells and gullies, and the countryside scatter (barley by season, date groves, reed banks, dune scrub, sherds) (HANDOFF "Stage V batch 3"). Batch 4 (2026-09-26) — the fauna: herds by the kernel's head count, the city's beasts and pets, jackals by night, flocks of doves, fowl, waders and vultures that scatter from the player (HANDOFF "Stage V batch 4"). Batch 5 (2026-09-26) — the atmosphere: the kernel's weather on screen (rain, dust storms, fog, wet ground), smoke on the fire schedule, the real night sky with the zodiac, canals that sink in the drought, festival dressing at the temple (HANDOFF "Stage V batch 5"); its sound half waits for a Freesound key. Next: batch 5 sound, then batch 6 the props library.
