...
**Progress:** P0a (the kernel and C API half of P0: FND-01…06, FND-09) is done on branch `mech/p0a-foundations` — plan [2026-09-26-p0a-kernel-foundations.md](superpowers/plans/2026-09-26-p0a-kernel-foundations.md), contract [module_Items.md](../kernel/contracts/module_Items.md). P0b (the Unreal verb wheel, UI kit and toasts: FND-07, FND-08, UI-03) is next.
