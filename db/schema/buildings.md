...
**Rows:** 7 · **Source:** canon rows authored from the designer's notes ([world-bible](../../docs/world-bible.md)) or reserved for later phases.

## Fields

```
id,name,kind,city_or_context,canon,tag,source_ref
```
