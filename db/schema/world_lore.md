...
**Rows:** 5 · **Source:** canon rows authored from the designer's notes ([world-bible](../../docs/world-bible.md)) or reserved for later phases.

## Fields

```
id,subject,canon,tag,source_ref
```
