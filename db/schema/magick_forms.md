...
**Rows:** 10 · **Source:** canon rows authored from the designer's notes ([world-bible](../../docs/world-bible.md)) or reserved for later phases.

## Fields

```
id,form,canon,system_slot,tag,source_ref
```
